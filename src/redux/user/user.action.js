...
export const userLogin = (data, navigation, methodCall) => {
  return (dispatch) => {
    ...
    axios
      .get(`${Url}get_login_api?login=${username}&password=${password}`, { headers: headers })
      .then((response) => {
...
export const userSignup = (data, navigation, methodCall) => {
  return (dispatch) => {
    ...
    axios
      .get(`${Url}signup_api?email=${email}`, { headers: headers })
      .then((response) => {
        const user = response.data;
        alert(user.result);
...
export const ForgotPasswordApi = (data, navigation) => {
  return (dispatch) => {
    ...
    axios
      .get(`${Url}resetPassword_api?email=${email}`, { headers: headers })
      .then((response) => {
...
export const ResetPasswordApi = (data) => {
  return (dispatch) => {
    ...
    axios
      .get(`${Url}updateResetPassword_API?temp_password=${temp_password}&new_password=${new_password}&email=${email}`, { headers: headers })
      .then((response) => {
