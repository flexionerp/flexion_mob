...
const SearchBar = ({ value, getInputValue, pcolor }) => {
  const clicked = (value) => {
    getInputValue("");
  };
  ...
  return (
    <View style={styles.container}>
      <View style={styles.main}>
        <TextInput style={styles.inputStyle} placeholder={"Search Units"} placeholderTextColor={pcolor} onChangeText={(text) => getInputValue(text)} value={value} />
