import { StyleSheet, Text, View, ImageBackground, ActivityIndicator, KeyboardAvoidingView, Platform, ScrollView, TouchableOpacity, TextInput } from "react-native";
...
export function Login({ navigation, route }) {
  ...
  const isLogin = async () => {
    ...
    try {
      ...
      // If email or password not found in AsyncStorage, set loading to false and return
    ...
    >
      <ImageBackground source={ICONS.bgImg} style={styles.container}>
        <ScrollView
          ...
          style={{ width: "100%" }}
          contentContainerStyle={{ flex: 1, width: "100%", backgroundColor: "transparent", alignItems: "center", justifyContent: "center" }}
        >
          <View style={styles.main}>
            ...
            <View style={{ width: "80%" }}>
              ...
              />
              <CustomPassFieldIcon placeholder="Password" value={password} getValue={setPassword.bind(this)} keyboardType={"email-address"} />
              <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginTop: -4 }}>
                <View style={styles.remember}>
                  <CheckBox value={remember} getValue={setRemember.bind(this)} />
                  <Text style={styles.rememberText}>Remember Me ?</Text>
                </View>
                <Text onPress={() => navigation.navigate("ForgotPassword")} style={styles.forgotStyle}>
                  Forgot Password?
                </Text>
              </View>
              ...
              <View style={styles.btnRow}>
                {loader ? (
                  ...
                  <RegularBtn label={"Sign in"} size="65%" onClick={() => apiHit()} bgColor={COLORS.primary} />
                )}
              </View>
            </View>
            <View style={{ height: CUSTOMHEIGHT(4) }} />
            <Text onPress={() => navigation.navigate(SCREENS.SIGNUPSCREEN)} style={styles.footerText}>
                    ...
                    >
                      <View style={{ marginLeft: 5, flexDirection: "row", alignItems: "center" }}>
                        ...
                        <TextInput
                          ...
                          editable={false}
                          style={{ fontSize: 13, color: "#FFFFFF", marginLeft: 10, width: 60, height: 30, textAlign: "right", marginTop: 5, width: CUSTOMWIDTH("24") }}
                        >
                          {item.password}
                        </TextInput>
                      </View>
