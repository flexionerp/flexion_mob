...
export const LeadAgentChange = ({ navigation, route }) => {
  const currentAgent = route.params?.currentAgent;
  ...
  const fetchData = async () => {
    try {
      ...
      const filteredItems = loginNames.filter((item) => item.value !== currentAgent);
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={{ justifyContent: "center", alignItems: "center", width: "100%" }}>
        ...
        <View style={{ marginTop: RFPercentage(2.5), width: "90%", justifyContent: "center", alignItems: "center", alignSelf: "center", flexDirection: "row" }}>
          <Text style={{ fontSize: RFPercentage(2.4), color: "#06143b", fontFamily: FONTS.Medium }}>Lead Agent Edit</Text>
        ...
        <View style={{ marginTop: RFPercentage(4), width: "90%", justifyContent: "flex-start", alignItems: "center", flexDirection: "row" }}>
          <Text style={{ fontSize: RFPercentage(2), color: "#06143b", fontFamily: FONTS.Medium }}>Current Agent: {currentAgent}</Text>
        </View>
