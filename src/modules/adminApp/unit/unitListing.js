import { StyleSheet, Text, View, SafeAreaView, ImageBackground, TouchableOpacity, FlatList, ActivityIndicator, Platform } from "react-native";
...
const Item = ({ navigation, data }) => {
  ...
  return (
    <View style={styles.itemContainer}>
      <ImageBackground source={ICONS.unitBG} style={styles.bgStyle} resizeMode="cover">
        ...
        <View style={styles.right}>
          ...
          <ImageBackground source={ICONS.progressBar} style={styles.progressBar}>
            <Text style={styles.salePrice}>
              Sale Price{"\n"}
              <Text style={{ fontSize: SCREEN_WIDTH * 0.03 }}>{SALE_VALUE.trim()}</Text>
            </Text>
          </ImageBackground>
          <View style={{ width: "100%", marginBottom: -2, flexDirection: "row", alignItems: "center", justifyContent: "flex-end", paddingRight: 10 }}>
...
const UnitListing = ({ navigation, route }) => {
  ...
  return (
    <ImageBackground source={ICONS.bgImg} style={styles.container} resizeMode="cover">
