...
const CommissionDetail = ({ navigation, route }) => {
    ...
    return (
        <SafeAreaView style={styles.container}>
            <Header value={search} getInputValue={getSearch.bind(this)} />
            <View style={{ height: 3, width: '100%' }} />
            <View style={styles.btnsRow}>
                <TouchableOpacity onPress={preReport} style={{ flexDirection: 'row', alignItems: 'center', marginRight: 5 }} >
                    <Text style={styles.btnLabel} >Previous Comm.{'\n'}Report</Text>
                    <Icon name='arrow-right' size={14} />
                </TouchableOpacity>
                <TouchableOpacity onPress={currentReport} style={{ flexDirection: 'row', alignItems: 'center', marginRight: 5 }} >
                    <Text style={styles.btnLabel} >Current Month{'\n'}Comm. Report</Text>
                    <Icon name='arrow-right' size={14} />
                </TouchableOpacity>
                <TouchableOpacity onPress={approveReport} style={{ flexDirection: 'row', alignItems: 'center', marginRight: 5 }} >
                    <Text style={styles.btnLabel} >Approved Monthly{'\n'}Comm. Report</Text>
                    <Icon name='arrow-right' size={14} />
                </TouchableOpacity>
            </View>
            <View style={styles.btnsRow}>
                <TouchableOpacity onPress={() => setIsModalVisible(true)} style={{ flexDirection: 'row', alignItems: 'center', marginRight: 5 }} >
                    <Text style={styles.btnLabel} >Upload Invoice</Text>
                    <Icon name='arrow-right' size={14} />
                </TouchableOpacity>
                <TouchableOpacity onPress={generateComm} style={{ flexDirection: 'row', alignItems: 'center', marginRight: 5 }} >
                    <Text style={styles.btnLabel} >Generate Comm.</Text>
                    <Icon name='arrow-right' size={14} />
                </TouchableOpacity>
                <TouchableOpacity onPress={sendApproval} style={{ flexDirection: 'row', alignItems: 'center', marginRight: 5 }} >
