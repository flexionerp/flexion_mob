    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.btnsRow}>
                <TouchableOpacity onPress={currentBroker} style={{ flexDirection: 'row', alignItems: 'center', marginRight: 5 }} >
                    <Text style={styles.btnLabel} >Current Broker</Text>
                    <Icon name='arrow-right' size={14} />
                </TouchableOpacity>
                <TouchableOpacity onPress={progressBroker} style={{ flexDirection: 'row', alignItems: 'center', marginRight: 5 }} >
                    <Text style={styles.btnLabel} >Progress Broker</Text>
                    <Icon name='arrow-right' size={14} />
                </TouchableOpacity>
                <TouchableOpacity onPress={generalBroker} style={{ flexDirection: 'row', alignItems: 'center', marginRight: 5 }} >
