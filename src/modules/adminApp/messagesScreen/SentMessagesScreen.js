...
export const SentMessagesScreen = ({ navigation, route }) => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <BackButton navigation={navigation} label="Inbox Details" />
      <ScrollView nestedScrollEnabled showsVerticalScrollIndicator={false} style={{ width: "100%" }}>
        <View style={{ justifyContent: "center", alignItems: "center", width: "100%" }}>
          {/* Recent */}
          <View style={{ flexDirection: "row", marginTop: RFPercentage(3), width: "86%", justifyContent: "flex-start", alignItems: "center" }}>
