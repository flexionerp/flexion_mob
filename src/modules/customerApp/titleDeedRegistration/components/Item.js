...
export const Item = ({ navigation, data }) => {
    let { TITLE_DEED, REG_DATE, DESCRIPTION } = data
    ...
    return (
            ...
            <ImageBackground
                ...
                <View style={styles.left}>
                    <View style={styles.top}>
                        <Text style={styles.unitCode}>{TITLE_DEED}</Text>
                    </View>
                    <View style={styles.center}>
                        <Text style={styles.area}>Registration Date - {moment(REG_DATE).format('DD-MMM-YYYY hh:mm:ss')}</Text>
                ...
                <View style={styles.right}>
                    ...
                    <View style={{ width: '100%', marginBottom: 5, flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-end', paddingRight: 2 }} >
                        <TouchableOpacity onPress={() => { }} style={{ flexDirection: 'row', alignItems: 'center', }}>
                            <Text style={styles.detail} >Preview</Text>
        ...
        //             <Text style={styles.value} >{TITLE_DEED}</Text>
        //         </View>
        //     </View>
