...
import { COLORS, CUSTOMWIDTH, FONTS, SCREEN_WIDTH, Url } from '../../../constants';
...
import { CustomMultiInput } from '../../../common/customMultiInputWhite';
...
export const Notes = ({ navigation, route }) => {
    ...
    const [typeName, setTypeName] = useState('GENERAL NOTE')
    ...
    const emputyComponent = () => (
        <Text style={{ color: '#000000', fontSize: 11, fontFamily: FONTS.SemiBold, alignSelf: 'center' }} >Empty Result</Text>
    );
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <Text style={styles.pp} >Notes</Text>
            <BackButton navigation={navigation} label="" />
            <View style={{ height: 3, width: '100%' }} />
            <TouchableOpacity onPress={() => setIsModalVisible(true)} style={{ flexDirection: 'row', alignItems: 'center', marginRight: 5 , marginBottom:12}} >
                <Text style={[styles.btnLabel,{fontSize: 14}]} >Add Note</Text>
