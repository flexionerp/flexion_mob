import {
    ...
    ScrollView, Image, TouchableOpacity, FlatList, ActivityIndicator, Platform
} from 'react-native'
            ...
            <ImageBackground
                ...
                <View style={styles.left}>
                    ...
                    <View style={styles.bottom}>
                        <TouchableOpacity disabled={true} style={styles.btnStyle}>
                            <View style={styles.btnImg} >
                                {/* <Image source={ICONS.cardBlack} style={{ width: 26, height: 26 }} />
                                <Text style={styles.btnLable}>Pay now</Text> */}
                            </View>
                        </TouchableOpacity>
                    </View>
                </View>
...
const styles = StyleSheet.create({
    ...
    bgStyle: {
        ...
        height: Platform.OS == 'ios' ? SCREEN_HEIGHT * 0.23 : SCREEN_HEIGHT * 0.3
    },
    left: {
        width: '53%',
    },
