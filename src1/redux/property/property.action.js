...
export const getCustomerReceivables = () => {
  return dispatch => {
    ...
    axios.get(`${Url}get_pie_customer_Receivables`,
      { headers: headers })
      .then(resp => {
...
export const getCollections = () => {
  return dispatch => {
    ...
    axios.get(`${Url}get_pie_oncollection`,
...
export const getPropertyStats = () => {
  return dispatch => {
    ...
    axios.get(`${Url}get_pie_chart_property`,
      { headers: headers })
      .then(resp => {
        let response = resp.data;
...
export const getReservationList = (id) => {
  return dispatch => {
    ...
    axios.get(`${Url}get_reservation_grid_api?user_info_id=${id}`,
      { headers: headers })
      .then(resp => {
        let response = resp.data;
        console.log("getReservationList: ", response.data.length);
...
export const getWeeklyStats = () => {
  return dispatch => {
    ...
    axios.get(`${Url}get_pie_onweeklysale`,
      { headers: headers })
      .then(resp => {
        let response = resp.data;
...
export const getSaleTowerBStats = () => {
  return dispatch => {
    ...
    axios.get(`${Url}get_pie_onsaletowerb`,
      { headers: headers })
      .then(resp => {
        let response = resp.data;
...
export const getSaleTowerAStats = () => {
  return dispatch => {
    ...
    axios.get(`${Url}get_pie_onsaletowera`,
      { headers: headers })
      .then(resp => {
        let response = resp.data;
...
export const getWeeklyTowerBStats = () => {
  return dispatch => {
    ...
    axios.get(`${Url}get_pie_onweeklysaletowerb`,
      { headers: headers })
      .then(resp => {
        let response = resp.data;
...
export const getWeeklyTowerAStats = () => {
  return dispatch => {
    ...
    axios.get(`${Url}get_pie_onweeklysaletowera`,
      { headers: headers })
      .then(resp => {
        let response = resp.data;
...
export const getMonthlyStats = () => {
  return dispatch => {
    ...
    axios.get(`${Url}piechartonsaleDataAPI`,
      { headers: headers })
      .then(resp => {
        let response = resp.data;
...
export const getCancellationStats = () => {
  return dispatch => {
    ...
    axios.get(`${Url}get_cancelled_data_dashboard`,
      { headers: headers })
      .then(resp => {
        let response = resp.data;
...
export const getBrokerStats = () => {
  return dispatch => {
    ...
    axios.get(`${Url}get_broker_master_data`,
      { headers: headers })
      .then(resp => {
        let response = resp.data;
...
export const getCustomerMasterStats = () => {
  return dispatch => {
    ...
    axios.get(`${Url}get_customer_master_data`,
      { headers: headers })
      .then(resp => {
        let response = resp.data;
...
export const callGeneralApi = (data) => {
  ...
  return dispatch => {
    ...
    axios.get(`${Url}View_Reservation_FormAPI?hdr_id=${ID}&org_id=${ORG_ID}&status=${STATUS}`,
      { headers: headers })
      .then(resp => {
        let response = resp.data;
...
export const getReceiptList = (id) => {
  return dispatch => {
    ...
    axios.get(`${Url}get_receipts_details_API?id=${id}`,
      { headers: headers })
      .then(resp => {
        let response = resp.data;
...
export const getReceiptsList = (id) => {
  return dispatch => {
    ...
    axios.get(`${Url}get_receipts_api?USER_INFO_ID=${id}`,
      { headers: headers })
      .then(resp => {
        let response = resp.data;
...
export const getCustomerReceivable = (id, cid) => {
  ...
  return dispatch => {
    ...
    axios.get(`${Url}customer_receiablesAPI?USER_INFO_ID=${id}&customerid=${cid}`,
      { headers: headers })
      .then(resp => {
        let response = resp.data;
        if (cid == 0) {
...
export const getReceivablebyUnit = (id) => {
  ...
  return dispatch => {
    ...
    axios.get(`${Url}receivable_by_unit_detail_API?USER_INFO_ID=${id}`,
      { headers: headers })
      .then(resp => {
        let response = resp.data;
...
export const getHomelist = (id, name) => {
  ...
  return dispatch => {
    ...
    axios.get(`${Url}home_api?USER_INFO_ID=${id}&LOGIN_NAME=${name}`,
      { headers: headers })
      .then(resp => {
        let response = resp.data;
...
export const getCountList = () => {
  return dispatch => {
    ...
    axios.get(`${Url}get_unit_form_API`,
      { headers: headers })
      .then(resp => {
        let response = resp.data;
...
export const getDuesCount = (id) => {
  return dispatch => {
    ...
    axios.get(`${Url}get_14bucket_API?USER_INFO_ID=${id}`,
      { headers: headers })
      .then(resp => {
        let response = resp.data;
...
export const getCountryList = () => {
  return dispatch => {
    ...
    axios.get(`${Url}get_customer_form_api`,
      { headers: headers })
      .then(resp => {
        let response = resp.data;
...
export const getCityList = (id) => {
  return dispatch => {
    ...
    axios.get(`${Url}get_city_by_countrys?country_id=${id}`,
      { headers: headers })
      .then(resp => {
...
export const insertCustomer = (data, navigation) => {
  const {
    dob, name, type, fname, lname, namear,
    country, city, country1, city1, address1,
    USER_INFO_ID, email
  } = data
  return dispatch => {
    let headers = {
    ...
    axios.get(`${Url}insert_customer_api?dob=${dob}&name=${name}&type=${type}&fname=${fname}&lname=${lname}&namear=${namear}&country=${country}&city=${city}&country1=${country1}&city1=${city1}&address1=${address1}&USER_INFO_ID=${USER_INFO_ID}&email=${email}`,
      { headers: headers })
      .then(resp => {
        let response = resp.data;
...
export const getCommissionList = (id) => {
  return dispatch => {
    ...
    axios.get(`${Url}broker_commission_api?USER_INFO_ID=${id}`,
      { headers: headers })
      .then(resp => {
        let response = resp.data;
...
export const getCustomersList = () => {
  return dispatch => {
    ...
    axios.get(`${Url}getCustomerByOrgId?org_id=33`,
      { headers: headers })
      .then(resp => {
        let countryList = resp.data;
        let temp = []
...
export const getReservationNoList = (id) => {
  ...
  return dispatch => {
    ...
    axios.get(`${Url}getReservationByCustomerId?id=${id}`,
      { headers: headers })
      .then(resp => {
        let countryList = resp.data;
        let temp = []
...
export const insertReceipt = (data, navigation) => {
  const {
    PRE_RESERVATION_NO, CUSTOMER, NARRATION, RECEIPT_DATE,
    RECEIVED_FROM, REFERENCE_CODE, CURR, USER_INFO_ID,
  } = data
  return dispatch => {
    let headers = {
      'Content-Type': 'application/json'
    };
    axios.get(`${Url}insertReceipt_api?PRE_RESERVATION_NO=${PRE_RESERVATION_NO}&CUSTOMER=${CUSTOMER}&NARRATION=${NARRATION}&ORG=33&RECEIPT_DATE=${RECEIPT_DATE}&RECEIVED_FROM=${RECEIVED_FROM}&REFERENCE_CODE=${REFERENCE_CODE}&CURR=2&USER_INFO_ID=${USER_INFO_ID}`,
      { headers: headers })
      .then(resp => {
        let response = resp.data;
...
export const getBankModeList = () => {
  return dispatch => {
    ...
    axios.get(`${Url}get_mod_and_banks`,
      { headers: headers })
      .then(resp => {
        let countryList = resp.data;
        let tempBank = []
...
export const insertPaymentDetail = (data, navigation) => {
  const {
    cheque, amount, hdr_id, modOfPay,
    dueDate, bank, NARRATION, USER_INFO_ID,
    category, branch
  } = data
  return dispatch => {
    let headers = {
    ...
    axios.get(`${Url}insertReceiptDetails_api?cheque=${cheque}&amount=${amount}&hdr_id=${hdr_id}&modOfPay=${modOfPay}&dueDate=${dueDate}&bank=${bank}&NARRATION=${NARRATION}&USER_INFO_ID=${USER_INFO_ID}&category=${category}&branch=${branch}`,
      { headers: headers })
      .then(resp => {
        let response = resp.data;
        console.log(response)
...
export const insertApproval = (data) => {
  const {
    RESERVE_ID, PRE_RESERVE_ID, PK, LEVEL,
    USER_INFO_ID, LOGIN_NAME, TYPE, COMMENTS,
    ORG_ID, UNIT_ID, conf_val, conf_val1, dt
  } = data
  return dispatch => {
    let headers = {
      'Content-Type': 'application/json'
    };
    axios.get(`${Url}Insert_Approval_Confirmation_api?RESERVE_ID=${RESERVE_ID}&PRE_RESERVE_ID=${PRE_RESERVE_ID}&PK=${PK}&LEVEL=${LEVEL}&USER_INFO_ID=${USER_INFO_ID}&LOGIN_NAME=${LOGIN_NAME}&TYPE=${TYPE}&COMMENTS=${COMMENTS}&ORG_ID=${ORG_ID}&UNIT_ID=${UNIT_ID}&conf_val=${conf_val}&conf_val1=${conf_val1}&dt=${dt}`,
      { headers: headers })
      .then(resp => {
        let response = resp.data;
        alert("Record update!")
...
export const insertConfirmReceipt = (data) => {
  ...
  return dispatch => {
    ...
    axios.get(`${Url}confirmReceipthdrapi?id=${id}&reserve_id=${reserve_id}&USER_INFO_ID=${USER_INFO_ID}`,
      { headers: headers })
      .then(resp => {
        let response = resp.data;
        alert("Record update!")
...
export const insertGenearteCommission = (data) => {
  ...
  return dispatch => {
    ...
    axios.get(`${Url}generatecomm_api?brokerid=${brokerid}`,
      { headers: headers })
      .then(resp => {
        let response = resp.data;
...
export const generateLink = (data) => {
  ...
  return dispatch => {
    ...
    axios.get(`${Url}generatepaymentlink_api?due=${due}&unit_code=${unit_code}&id=${id}&name=${name}&email=a`,
      { headers: headers })
      .then(resp => {
        let response = resp.data;
        console.log(response)
...
export const getBrokerList = (data) => {
  return dispatch => {
    ...
    axios.get(`${Url}property_res_form_api?org_id=33&unit_id=${unit_id}&USER_INFO_ID=${USER_INFO_ID}`,
      { headers: headers })
      .then(resp => {
        let response = resp.data;
        dispatch(setUnitDetail(response.result2[0]))
        console.log("getBrokerList: ", response.result2[0])
        let tempPlan = []
        let tempBroker = []
        let tempAgent = []
...
export const insertPreReservation = (data, navigation) => {
  ...
  return dispatch => {
    ...
    axios.get(`${Url}insert_pre_reservation1_API?pre_res_dt=${pre_res_dt}&sale_val=${sale_val}&unit_id=${unit_id}&prop_id=${PROPERTY_ID}&unit_desc_id=${UNIT_SPECS_ID}&price=${price}&pricetype=${PRICE_TYPE}&payment_plan=${payment_plan}&agent=${agent}&broker=${broker}&USER_INFO_ID=${USER_INFO_ID}&Customer_ID=${Customer_ID}&Primary=1&Per=${Per}&org_id=33`,
      { headers: headers })
      .then(resp => {
        let response = resp.data;
...
export const insertPay = (data, navigation) => {
  ...
  return dispatch => {
    ...
    axios.get(`${Url}generatepaymentlink_api1?due=${due}&unit_code=${unit_code}&id=${id}&name=${name}&email=a`,
      { headers: headers })
      .then(resp => {
        let response = resp.data;
...
export const composeEmail = (data) => {
  ...
  return dispatch => {
    ...
    axios.get(`${Url}send_notes_email_api?to=info@fakhruddinproperties.com&cc=info@fakhruddinproperties.com&subject=${subject}&notes=${message}&rid=${rid}&USER_INFO_ID=${USER_INFO_ID}`,
      { headers: headers })
      .then(resp => {
        let response = resp.data;
