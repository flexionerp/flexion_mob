...
export const History = ({ navigation, route }) => {
        ...
        const filteredUnites = unit_list
            ? unit_list.filter((filterUnit) => {
                return (
                    ...
                    moment(filterUnit.CREATED_ON).format('MM-DD-YYYY')
                        .toLowerCase()
                        .includes(item.toLowerCase()) ||
                    filterUnit.COMMENTS &&  filterUnit.COMMENTS
                        .toLowerCase()
                        .includes(item.toLowerCase()) ||
    ...
    return (
        <SafeAreaView style={styles.container}>
            <Header navigation={navigation} label="History" value={search} getInputValue={getSearch.bind(this)} />
