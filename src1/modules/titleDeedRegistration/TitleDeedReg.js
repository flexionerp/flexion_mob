...
export const TitleDeedReg = ({ navigation, route }) => {
    ...
    return (
        <SafeAreaView style={styles.container}>
            <Header navigation={navigation} label="Title Deed Reg" value={search} getInputValue={getSearch.bind(this)} />
