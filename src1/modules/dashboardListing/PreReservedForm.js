        ...
        <View style={{ flex: 1, width: "100%", alignItems: "center" }}>
          <ScrollView style={{ width: "100%" }} contentContainerStyle={{ width: "100%", alignItems: "center" }}>
            <View style={styles.bottom}>
              ...
              <CustomInput label="Customer Percentage" placeholder="Enter Percentage" value={percent.toString()} getValue={setPercent.bind(this)} keyboardType={"number-pad"} />
            </View>
            <View style={{ height: 20 }} />

            {loader ? <ActivityIndicator color={COLORS.primary} size="small" /> : <RegularBtn label={"Save + Next"} size={"90%"} bgColor={COLORS.primary} onClick={() => apiHit()} />}
